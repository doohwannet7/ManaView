...
namespace ManaView.MVVM.AttachedCommandBehavior
{
    /// <summary>
    ...
    public class BehaviorBinding : Freezable
    {
        ...
        #region IsCommandParameterBinded

        /// <summary>
        /// IsCommandParameterBinded Dependency Property
        /// </summary>
        public static readonly DependencyProperty IsCommandParameterBindedProperty =
            DependencyProperty.Register("IsCommandParameterBinded", typeof(bool), typeof(BehaviorBinding),
                new FrameworkPropertyMetadata((bool)true,
                    new PropertyChangedCallback(OnIsCommandParameterBindedChanged)));

        /// <summary>
        /// Gets or sets the IsCommandParameterBinded property.  
        /// </summary>
        public bool IsCommandParameterBinded
        {
            get { return (bool)GetValue(IsCommandParameterBindedProperty); }
            set { SetValue(IsCommandParameterBindedProperty, value); }
        }

        /// <summary>
        /// Handles changes to the IsCommandParameterBinded property.
        /// </summary>
        private static void OnIsCommandParameterBindedChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ((BehaviorBinding)d).OnIsCommandParameterBindedChanged(e);
        }

        /// <summary>
        /// Provides derived classes an opportunity to handle changes to the IsCommandParameterBinded property.
        /// </summary>
        protected virtual void OnIsCommandParameterBindedChanged(DependencyPropertyChangedEventArgs e)
        {
            Behavior.IsCommandParameterBinded = IsCommandParameterBinded;
        }
