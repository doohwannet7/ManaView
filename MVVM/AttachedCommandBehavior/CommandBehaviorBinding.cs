...
namespace ManaView.MVVM.AttachedCommandBehavior
{
    ...
    public class CommandBehaviorBinding : IDisposable
    {
        ...
        private bool _IsCommandParameterBinded = true;
        /// <summary>
        /// True: Using user commandparameter
        /// False: Using EventArgs
        /// </summary>
        public bool IsCommandParameterBinded
        {
            get
            {
                return _IsCommandParameterBinded;
            }
            set
            {
                _IsCommandParameterBinded = value;
            }
        }
        ...
        /// </summary>
        /// <param name="sender">sender: Owner</param>
        /// <param name="e">EvenrArgs</param>
        private void OnEventRaised(object sender, EventArgs e)
        {
            if (strategy != null)
            {
                if (IsCommandParameterBinded == false)
                {
                    CommandParameter = e;
                }
