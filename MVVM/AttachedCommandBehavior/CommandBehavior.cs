...
namespace ManaView.MVVM.AttachedCommandBehavior
{
    ...
    public class CommandBehavior
    {
        ...
        #region IsCommandParameterBindedProperty

        /// <summary>
        /// CommandParameter Attached Dependency Property
        /// </summary>
        public static readonly DependencyProperty IsCommandParameterBindedPropertyProperty =
            DependencyProperty.RegisterAttached("IsCommandParameterBinded", typeof(bool), typeof(CommandBehavior),
                new FrameworkPropertyMetadata((object)true,
                    new PropertyChangedCallback(OnIsCommandParameterBindedPropertyChanged)));

        /// <summary>
        /// Gets the CommandParameter property.  
        /// </summary>
        public static bool GetIsCommandParameterBinded(DependencyObject d)
        {
            return (bool)d.GetValue(IsCommandParameterBindedPropertyProperty);
        }

        /// <summary>
        /// Sets the CommandParameter property. 
        /// </summary>
        public static void SetIsCommandParameterBinded(DependencyObject d, bool value)
        {
            d.SetValue(IsCommandParameterBindedPropertyProperty, value);
        }

        /// <summary>
        /// Handles changes to the CommandParameter property.
        /// </summary>
        private static void OnIsCommandParameterBindedPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            CommandBehaviorBinding binding = FetchOrCreateBinding(d);
            binding.IsCommandParameterBinded = (bool)e.NewValue;
        }
